	...
	return (
		...
		>
			...
			<div className="p-4 flex flex-col items-center">
				...
				{isHovered && (
					<button
						className="mt-2 flex self-center items-center text-white bg-red-500 px-3 py-1 rounded-lg hover:bg-red-700 transition"
						onClick={onClick}
					>
						Read More
					</button>
	...
	return (
		...
		>
			...
			>
				...
				/>
				<button
					className="mt-4 px-4 py-2 bg-gray-700 self-center text-white rounded-lg"
					onClick={onClose}
				>
					Close
				</button>
...
const CardGrid = () => {
	...
	const cardsData = [
		{
			...
			shortDescription:
				"YouTube remains at the forefront of video content, with trends shifting towards short-form videos...",
			fullDescription:
		...
		},
		{
			...
			shortDescription:
				"X has transformed into a real-time news and discussion hub, with an emphasis on longer-form content...",
			fullDescription:
	...
	return (
		<div className="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-16 max-w-4xl mx-auto">
