...
const Card = ({ title, description, imgSrc }) => (
	<div className="max-w-sm rounded-lg shadow-lg overflow-hidden bg-black hover:scale-105 transform transition-all duration-300">
		...
		<div className="p-6">
			...
			<p className="mt-2 text-[#00FF41]/90">{description}</p>
		</div>
	</div>
);
			...
			<div className="relative isolate px-6 pt-14 lg:px-8">
				...
				>
					<div
						...
						className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#00FF41] to-[#006166] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
					/>
				</div>
