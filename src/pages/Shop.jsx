...
import vlogCamera from "../assets/vlog-camera.jpg";
...
const Shop = () => {
  const products = [
    ...
    },
    {
      ...
      "price": "€98.84",
      "image": "assets/elgato-ring-light.jpg",
    ...
    },
    {
      ...
      "price": "€227.83",
      "image": "/assets/razer-keyboard.jpg",
