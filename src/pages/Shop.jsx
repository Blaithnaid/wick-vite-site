	...
	const products = [
		{
			...
			imageSrc: c920,
			buyLink:
				"https://www.amazon.co.uk/Webcam-PC-Microphone-Conference-Facetime/dp/B099DF2RNS",
		},
		{
			id: 2,
			...
			imageSrc: mic,
			buyLink:
				"https://www.amazon.co.uk/Razer-Seiren-Windscreen-Filter-YOUSHARES/dp/B09XFYB9R8",
		},
		{
			id: 3,
			...
			imageSrc: steamDeck,
			buyLink:
				"https://www.amazon.co.uk/Elgato-Stream-Actions-Apps-Software-Like-OBS/dp/B07RL8H55Z",
		},
		{
			id: 4,
			...
			imageSrc: lightRing,
			buyLink:
				"https://www.amazon.co.uk/NEEWER-Ring-Light-Kit-Smartphone/dp/B01N0OJPXC",
		},
		{
			id: 5,
			...
			imageSrc: mic2,
			buyLink:
				"https://www.amazon.co.uk/Blue-Yeti-Mic-Stand-Filter/dp/B0BKPRZB7V",
		},
		{
			id: 6,
			...
			imageSrc: vlogCamera,
			buyLink:
				"https://www.amazon.co.uk/Photography-Vlogging-180%C2%B0Flip-Beginner-Batteries/dp/B0DJ2BQTRF",
		},
		{
			id: 7,
		...
		},
		{
			...
			imageSrc: camLink,
			buyLink:
				"https://www.amazon.co.uk/Elgato-Cam-Link-Broadcast-camcorder/dp/B07K3FN5MR/ref=sr_1_3?crid=1C503YO1EEKKY&dib=eyJ2IjoiMSJ9.UvfR7OQt4s7VnI1jy5-XKU4HOgHLyrIlFP56zdTJEFnmhQstx9fQu1HXjzoIBsARXedENFc5TZrAFa0cu8gs9Vqh50JOyt48T9hoWsFiuueBOaZTGsO3ClFXq88gVT4WkdV3rq8kP1ugZEZVtcxYQVMeErxQu3JxSRZ2gh6BzOh2dciXrsm2Nu-EWLMKxKgOLNH17zoy3W1GWbs0QVQOwmZoc_QSfBRWDYA9zoO9aw0.2ijoBrUGE5y9UBU_ECa_xrO7oaqnz4hdB27DDk676dI&dib_tag=se&keywords=Elgato%2BCam%2BLink%2B4K&qid=1740403660&sprefix=elgato%2Bcam%2Blink%2B4k%2Caps%2C160&sr=8-3&th=1",
		},
		{
			id: 9,
		...
		},
		{
			...
			imageSrc: logitech,
			buyLink:
				"https://www.amazon.co.uk/Logitech-Gaming-Headset-Generation-Headphone/dp/B07TLX61W7/ref=sr_1_3?crid=286KZAUWS4RPE&dib=eyJ2IjoiMSJ9.xRsqbbFCOJlh0mvsdL6So4eelIgwAOA3Alns3XwrjmQEoHObTE1oiuOS6gwnPKamcmo90-J_P2Hcdy_dJz02LsKb9vlleoCsGNJ0psmxsG_I4xDsct0NrZrEcPS1hmlvxsXctHpIDcwsUxqdtMSVt-rpQTqXWqGR_ht04I_9AVINuvUMpQUNPDGZqFqs8Rl-dECxBkk32QPALB8A3Yl-1I6M7alDd1w0sxDv8zwmigQ.cbaQFf4XIpjOSagDAtmePUkyqxKMyqcmLxneXhlEXxQ&dib_tag=se&keywords=Logitech%2BG%2BPro%2BX%2BGaming%2BHeadset&qid=1740404028&sprefix=logitech%2Bg%2Bpro%2Bx%2Bgaming%2Bheadset%2Caps%2C135&sr=8-3&th=1",
		},
		{
			id: 12,
		...
		},
		{
			...
			buyLink:
				"https://www.amazon.co.uk/Razer-Huntsman-Pro-Adjustments-Multi-function/dp/B0CDC2VLF4/ref=sr_1_3?crid=QGA3OXBUZVAO&dib=eyJ2IjoiMSJ9.20WW30necfPmPOKVl_7l50swLCp481J2MDirTLjZjilQtXg1fmqHADI4QHdrlbLebYgv9DcGsO5n2owPZ7wyKjodzwwoXnDe2gov0dLk1expTr_rJJkwP6xmjUaf6xD5Nb2flpqTaWWhCg3Dg_lZO7SPzP6xdOX6kOTdTqRaO4O0uzNqZLaEtJK-qjLIavLTvFkzkmtA7831U_dI7_nxpR16EnMLqwkPdC2CbgBMj1Y.0PPkH6pjC8YBaRlG0iynJzTYHXI7Yy-9NDNCT7-ucck&dib_tag=se&keywords=razer%2Bkeyboard&qid=1740404810&sprefix=razer%2B%2Caps%2C91&sr=8-3&th=1",
		},
		{
			id: 18,
			...
			imageSrc: desk,
			buyLink:
				"https://www.amazon.co.uk/Bestier-Outlets-Computer-Monitor-Workstation/dp/B0DB5KGCPV/ref=sr_1_3_sspa?crid=B1S16T91OP0L&dib=eyJ2IjoiMSJ9.DCYwxxJeADr3yn5fs1eHwKNhF-6A2N3Tb6kLsJd8pvno8-U4TZTwrKaJZlWCDE5XA2ZXpSjF_d_iTjBSP_q3wVOglkPQFZ_gQxCuonsVOaVp8MN6fox_IWEfdxTp1e6gZnXI3GgolrXM7XaF10FRoDNprjT9AYpy7dHxeODAaUUPkZ2_vCei2aEncRfpNAVrEDbEDHu9-5jfiyKDAgpsGRvNfD54Ep_NU968-3tbc5n_DentATIvJ2HSHy8tAyRXiaMKzPfs25IwGeCUE9dl7E2qXDD310eJ7i9Kmr0g_zY.fmyvMMtNczXn8g0fv2XnFepC7BkaJw_sgrnwiRM5s-k&dib_tag=se&keywords=Customizable%2BDesk&qid=1740404943&sprefix=customisable%2Bdesk%2Caps%2C154&sr=8-3-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&th=1",
		},
	];

	return (
		<div className="flex flex-col h-full w-full bg-oxford-400">
			<div className="text-center max-w-5xl py-12 bg-white min-h-screen mx-auto shadow-xl shadow-oxford-400 rounded-lg">
				<Header />
				<div className="flex flex-row justify-center mt-20 items-center flex-wrap">
					<div className="text-black text-left text-lg w-96 mx-auto">
						Looking to up your social media game? Here at Wick we've collated
						all the best gear to help you establish yourself as a content
						creator. From cameras, to microphones, to lighting gear, we've got
						you covered. Check out our recommendations below!
					</div>
					<div className="text-white text-sm mt-2 w-96 mx-auto p-4 bg-oxford-400 rounded-lg">
						By purchasing content through the links below, we make a small
						commission at no extra cost to you. This helps sustain Wick as a
						business!
					</div>
				</div>
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 p-5 pb-2">
					{products.map((product) => (
						<div
							key={product.id}
							className="bg-oxford-400 border-2 border-oxford-400 rounded-lg shadow-lg text-center overflow-hidden flex flex-col h-full transition-transform duration-300 hover:scale-105 hover:shadow-xl"
						>
							<div className="relative aspect-square flex-shrink-0">
								...
								/>
								<span className="absolute top-2 right-2 bg-white text-black font-bold text-md uppercase tracking-wide shadow-md px-2 py-1 rounded">
									{product.price}
								</span>
							</div>
							<div className="h-full flex flex-col justify-between">
								<h1 className="bg-oxford-400 text-iguana-400 font-semibold text-[14pt] px-2 pb-4 pt-2">
									{product.name}
								</h1>
								<div className="pb-4 bg-oxford-400">
									<a
										href={product.buyLink}
										className="px-6 mx-2 py-3 text-md w-fit rounded-lg font-bold bg-lavender-400 text-white transition-transform duration-200 hover:bg-green-500 hover:text-black hover:scale-110"
										target="_blank"
